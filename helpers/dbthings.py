...
async def handle_user_status(bot, cmd):
    ...
    if ban_status["is_banned"]:
        if (
            ...
            await cmd.reply_text("ꜱᴏʏʟᴇᴅɪɢɪᴍ ɪᴄɪɴ ᴜᴢɢᴜɴᴜᴍ! ᴀɴᴄᴀᴋ **ꜱᴇɴ ʙᴀɴʟɪꜱɪɴ** 😂! ɴᴇᴅᴇɴɪɴɪ ꜱᴏʀ **@jackdanielssx** ᴇɢᴇʀ ʙᴜɴᴜɴ ʙɪʀ ʜᴀᴛᴀ ᴏʟᴅᴜɢᴜɴᴜ ᴅᴜꜱᴜɴᴜʏᴏʀꜱᴀɴ.", quote=True)
            return
...
async def send_msg(user_id, message):
    try:
        ...
        return 400, f"{user_id} : ʙᴏᴛ ᴇɴɢᴇʟʟᴇᴅɪ\n"
...
async def main_broadcast_handler(m, db):
    ...
    out = await m.reply_text(
        text=f"**ʙʀᴏᴀᴅᴄᴀꜱᴛ ʙᴀꜱʟᴀᴅɪ !** ʙʀᴏᴀᴅᴄᴀꜱᴛ ʙɪᴛᴛɪᴋᴛᴇɴ ꜱᴏɴʀᴀ ʙɪʟɢɪ ᴠᴇʀᴇᴄᴇɢɪᴍ 😁!"
    )
    ...
    if failed == 0:
        await m.reply_text(
            text=f"ʙʀᴏᴀᴅᴄᴀꜱᴛ ᴛᴀᴍᴀᴍʟᴀɴᴅɪ ✅! \n**ᴛᴀᴍᴀᴍʟᴀɴᴅɪ:** `{completed_in}` \n\n**ᴛᴏᴘʟᴀᴍ ᴜꜱᴇʀ:** `{total_users}` \n**ᴛᴏᴘʟᴀᴍ ʙɪᴛᴇɴ:** `{done}` \n**ᴛᴏᴘʟᴀᴍ ɢᴏɴᴅᴇʀɪʟᴇɴ:** `{success}` \n**ᴛᴏᴘʟᴀᴍ ɢᴏɴᴅᴇʀɪʟᴍᴇʏᴇɴ:** `{failed}`",
            quote=True
        )
    else:
